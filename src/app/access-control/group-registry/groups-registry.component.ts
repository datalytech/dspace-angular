...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, FormsModule, ReactiveFormsModule, NgIf, ThemedLoadingComponent, PaginationComponent, NgFor, NgSwitch, NgSwitchCase, NgbTooltipModule, AsyncPipe, TranslateModule]
})
/**
