...
@Component({
    ...
    standalone: true,
    imports: [VarDirective, RouterLink, NgIf, ItemEditBitstreamDragHandleComponent, NgFor, ItemEditBitstreamBundleComponent, ThemedLoadingComponent, AsyncPipe, TranslateModule]
})
/**
