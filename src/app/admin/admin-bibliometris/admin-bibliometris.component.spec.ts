...
import { AdminBibliometrisComponent } from './admin-bibliometris.component';

describe('AdminBibliometrisComponent', () => {

  let component: AdminBibliometrisComponent;
  let fixture: ComponentFixture<AdminBibliometrisComponent>;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [AdminBibliometrisComponent],
      providers: [AdminBibliometrisComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AdminBibliometrisComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  });

  it('should create AdminBibliometrisComponent', inject([AdminBibliometrisComponent], (comp: AdminBibliometrisComponent) => {
