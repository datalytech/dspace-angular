...
import { ActivatedRoute, NavigationEnd, Router, Scroll, RouterLink } from '@angular/router';
...
@Component({
    ...
    standalone: true,
    imports: [VarDirective, NgIf, RouterLink, CollectionFormComponent, AsyncPipe, TranslateModule]
})
